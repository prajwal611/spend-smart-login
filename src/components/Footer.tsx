        ...
        <div className="border-t border-border mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            ...
            <a href="#" className="text-muted-foreground hover:text-primary transition-colors">
              ...
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                <path fillRule="evenodd" d="M4.98 3.5C4.98 4.881 3.87 6 2.5 6S.02 4.881.02 3.5C.02 2.12 1.13 1 2.5 1s2.48 1.12 2.48 2.5zm-2.48 20H.02V8.5h4.98V23.5zm6.98-11.5c0-1.381 1.12-2.5 2.5-2.5s2.48 1.119 2.48 2.5c0 1.38-1.1 2.5-2.48 2.5s-2.5-1.12-2.5-2.5zm2.48 11.5h-4.98v-9c0-1.105.895-2 2-2h.98c1.105 0 2 .895 2 2v9z" clipRule="evenodd" />
              </svg>
            </a>
          </div>
        </div>
